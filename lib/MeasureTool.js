...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__filter__ = __webpack_require__(60);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__data__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__enter__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__exit__ = __webpack_require__(59);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__join__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__merge__ = __webpack_require__(65);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__order__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__sort__ = __webpack_require__(75);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__call__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__nodes__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__node__ = __webpack_require__(66);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__size__ = __webpack_require__(74);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__empty__ = __webpack_require__(58);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__each__ = __webpack_require__(57);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__attr__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__style__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__property__ = __webpack_require__(69);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__classed__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__text__ = __webpack_require__(76);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__html__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__raise__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__lower__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__append__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__insert__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__remove__ = __webpack_require__(71);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__clone__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__datum__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__on__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__dispatch__ = __webpack_require__(56);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__creator__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__local__ = __webpack_require__(46);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__mouse__ = __webpack_require__(47);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__namespace__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__namespaces__ = __webpack_require__(8);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__selectAll__ = __webpack_require__(48);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__selector__ = __webpack_require__(10);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__touch__ = __webpack_require__(77);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__touches__ = __webpack_require__(78);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__window__ = __webpack_require__(12);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__selection_on__ = __webpack_require__(9);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__selection_on__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__noevent_js__ = __webpack_require__(15);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__window__ = __webpack_require__(12);
...
var _contextMenu = __webpack_require__(79);
...
var _singleContextMenu = __webpack_require__(80);

var _singleContextMenu2 = _interopRequireDefault(_singleContextMenu);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var SingleContextMenu = function () {
    function SingleContextMenu(overlay, context) {
        _classCallCheck(this, SingleContextMenu);
    ...
    _createClass(SingleContextMenu, [{
        key: 'onAdd',
        ...
        key: 'draw',
        value: function draw() {
            var divPosition = this._overlay.getProjection().fromLatLngToDivPixel(this.position);
        ...
        key: 'show',
        value: function show(position, cb) {
            var _this = this;
            ...
            this.containerDiv.classList.add(_config.Config.prefix + '-single-context-menu');
            this.containerDiv.id = _config.Config.prefix + '-single-context-menu';
            this.containerDiv.stylesheet = _singleContextMenu2.default;
            this.containerDiv.oncontextmenu = function (event) {
                return event.preventDefault();
            };

            var item = document.createElement("div");
            item.className = _config.Config.prefix + '-single-context-menu-item';
            item.innerHTML = '\n            <span class="' + _config.Config.prefix + '-context-menu-item-delete-icon"></span>\n            <span class="' + _config.Config.prefix + '-context-menu-item-text">Remove</span>\n        ';
            item.onclick = function (e) {
                e.preventDefault();
                cb.apply(_this._context);
                _this.hide();
            };
    ...
    return SingleContextMenu;
}();

exports.default = SingleContextMenu;
module.exports = exports['default'];
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__drag_js__ = __webpack_require__(42);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__nodrag_js__ = __webpack_require__(14);
...
var _singleContextMenu = __webpack_require__(29);
...
var _d3Drag = __webpack_require__(32);
...
var MeasureTool = function () {
  ...
  _createClass(MeasureTool, [{
    ...
    value: function _init() {
      ...
      this._singleContextMenu = new _singleContextMenu2.default(new google.maps.OverlayView(), this);
    ...
    value: function _onRemoveOverlay() {
      (0, _d3Selection.selectAll)('.' + _config.Config.prefix + '-measure-points-' + this._id).remove();
    }
    ...
    value: function _checkClick(mouseEvent) {
      ...
      if (!this._clicked && !this._dragged && this._nodeCircles.selectAll('circle[r="9"]').size() == 0 && !this._hoverCircle.select("circle").attr('cx')) {
    ...
    value: function _openContextMenu(d, i, target) {
      var _this4 = this;
      ...
      this._singleContextMenu.show(new google.maps.LatLng(d[1], d[0]), function () {
        self._geometry.removeNode(i);
        (0, _d3Selection.select)(target).classed('removed-circle', true);
        self._overlay.draw();
        if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) === false) {
          _this4._clicked = true;
        }
      });
    }
  }, {
    ...
    value: function _updateLine() {
      ...
      var linesAux = this._linesAux.selectAll("line").data(this._geometry ? this._geometry.lines : []).attr("class", "aux-line").attr('x1', function (d) {
        ...
        if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) === false) {
          var point = _helper2.default.findTouchPoint([_this5._projectionUtility.latLngToSvgPoint(d[0]), _this5._projectionUtility.latLngToSvgPoint(d[1])], [_d3Selection.event.offsetX, _d3Selection.event.offsetY]);
    ...
    value: function _onDragLine() {
      ...
      var isDragged = false;
      var lineDrag = (0, _d3Drag.drag)();

      if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) === false) {
        lineDrag.on('drag', function (d, i) {
          _this8._dragging = true;
          if (!isDragged) {
            isDragged = true;
            _this8._geometry.insertNode(i + 1, _this8._projectionUtility.svgPointToLatLng([_d3Selection.event.x, _d3Selection.event.y]));
            _this8._updateLine();
          ...
          _this8._updateHoverCirclePosition(_d3Selection.event.x, _d3Selection.event.y);
          _this8._updateLinePosition(_this8._linesBase, i + 1);
          _this8._updateLinePosition(_this8._linesAux, i + 1);
          if (_this8._options.showSegmentLength) {
            _this8._updateSegmentTextPosition(i + 1);
          }
          if (_this8._options.showAccumulativeLength) {
            _this8._updateNodeTextPosition(i + 1);
          }
          _this8._updateArea(i + 1, _this8._projectionUtility.svgPointToLatLng([_d3Selection.event.x, _d3Selection.event.y]));
        });

        lineDrag.on('start', function () {
          _d3Selection.event.sourceEvent.stopPropagation();
          _this8._hoverCircle.select("circle").attr('class', "cover-circle");
        ...
        lineDrag.on('end', function (d, i) {
          ...
          if (isDragged) {
            _this8._geometry.updateNode(i + 1, _this8._projectionUtility.svgPointToLatLng([_d3Selection.event.x, _d3Selection.event.y]));
            _this8._hideHoverCircle();
            _this8._overlay.draw();
            isDragged = false;
            _this8._showTooltipOnEvent(_config.Config.tooltipText1);
          }
          _this8._updateArea(i + 1, _this8._projectionUtility.svgPointToLatLng([_d3Selection.event.x, _d3Selection.event.y]));
          _this8._hoverCircle.select("circle").attr('class', "grey-circle");
    ...
    value: function _updateSegmentTextPosition(index) {
      ...
      if (index < this._geometry.lines.length) {
        this._segmentText.select('text:nth-child(' + (index + 1) + ')').attr('transform', function (d) {
          ...
          return _this9._helper.formatLength(_this9._helper.computeLengthBetween(_this9._projectionUtility.svgPointToLatLng([_d3Selection.event.x, _d3Selection.event.y]), d[1]));
        });
      }
      if (index > 0) {
        this._segmentText.select('text:nth-child(' + index + ')').attr('transform', function (d) {
          ...
          return _this9._helper.formatLength(_this9._helper.computeLengthBetween(d[0], _this9._projectionUtility.svgPointToLatLng([_d3Selection.event.x, _d3Selection.event.y])));
        });
      }
    }
  }, {
    ...
    value: function _updateNodeTextPosition(index) {
      ...
      this._nodeText.select('text:nth-child(' + (index + 1) + ')').attr('x', _d3Selection.event.x).attr('y', function () {
        var offset = void 0;
        if (index > 0 && _this10._projectionUtility.latLngToSvgPoint(_this10._geometry.nodes[index - 1])[1] < _d3Selection.event.y) {
          offset = 23;
        } else {
          offset = -7;
        }
      ...
      this._nodeText.select('text:nth-child(' + (index + 2) + ')').attr('y', function (d) {
        var offset = void 0;
        if (index + 1 > 0 && _d3Selection.event.y < _this10._projectionUtility.latLngToSvgPoint(d)[1]) {
          offset = 23;
        } else {
          offset = -7;
        }
      ...
      followingNodes.text(function (d, i) {
        var len = _this10._helper.computePathLength([].concat(_toConsumableArray(_this10._geometry.nodes.slice(0, index)), [_this10._projectionUtility.svgPointToLatLng([_d3Selection.event.x, _d3Selection.event.y])], _toConsumableArray(_this10._geometry.nodes.slice(index + 1, index + 1 + i))));
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__dispatch_js__ = __webpack_require__(39);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__nodrag_js__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__noevent_js__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__constant_js__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__event_js__ = __webpack_require__(43);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__sourceEvent__ = __webpack_require__(11);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__creator__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__selector__ = __webpack_require__(10);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js??ref--1-1!../node_modules/sass-loader/lib/loader.js??ref--1-2!./single-context-menu.scss", function() {
			var newContent = require("!!../node_modules/css-loader/index.js??ref--1-1!../node_modules/sass-loader/lib/loader.js??ref--1-2!./single-context-menu.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
