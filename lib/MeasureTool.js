...
var SingleContextMenu = function () {
    function SingleContextMenu(parentContainer) {
    ...
    _createClass(SingleContextMenu, [{
        ...
        value: function create() {
            ...
            this._singleContextMenu.classList.add(_config.Config.prefix + '-single-context-menu');
            this._singleContextMenu.id = _config.Config.prefix + '-single-context-menu';
            this._singleContextMenu.stylesheet = _singleContextMenu2.default;
            this._singleContextMenu.oncontextmenu = function (event) {
                return event.preventDefault();
            };
        ...
        key: 'show',
        value: function show(point, cb, context) {
            var _this = this;
            ...
            var isXOverflow = this._parentContainer.getBoundingClientRect().width <= point.x + this._singleContextMenu.getBoundingClientRect().width;
            var isYOverflow = this._parentContainer.getBoundingClientRect().height <= point.y + this._singleContextMenu.getBoundingClientRect().height;
        ...
        value: function hide() {
            if (this._singleContextMenu) {
                ...
                var cm = document.getElementById("measure-tool-single-context-menu");
                if (cm) {
                    cm.remove();
                }
            }
...
var MeasureTool = function () {
  ...
  _createClass(MeasureTool, [{
    ...
    value: function _init() {
      ...
      this._singleContextMenu = new _singleContextMenu2.default(this._containerDiv);
    ...
    value: function _openContextMenu(d, i, target) {
      ...
      var point = this._projection.fromLatLngToContainerPixel(new google.maps.LatLng(d[1], d[0]));
      this._singleContextMenu.show(point, function () {
